    ...
    <header className="w-full bg-primary-background border-b border-gray-700 shadow-xl">
      <div className="max-w-[80%] mx-auto py-5 px-8 flex items-center">
        ...
        <nav className="flex gap-4 ml-8">
          <Link 
            href="/"
            className={`text-[16px] transition-colors duration-200 font-medium px-4 py-2 rounded focus:outline-none ${
              pathname === '/' 
                ? 'text-white border' 
                : 'text-gray-400 hover:text-white border border-transparent'
            }`}
            style={pathname === '/' ? { borderColor: '#836EF9' } : {}}
          >
            Smart Account
          </Link>
          <Link 
            ...
            style={pathname === '/launchpad' ? { borderColor: '#836EF9' } : {}}
          >
            LaunchPad
          </Link>
          <Link 
            ...
            style={pathname === '/envio' ? { borderColor: '#836EF9' } : {}}
          >
            Envio Dashboard
          </Link>
        </nav>
        ...
        <div className="flex items-center gap-4">
          {isConnected && (
            <div className="relative" ref={networkDropdownRef}>
              <button
                ...
                className="h-10 px-2 bg-gray-800/80 backdrop-blur-sm border border-gray-600 rounded text-white hover:bg-gray-700 transition-all duration-200 shadow-lg flex items-center gap-1"
          ...
          {!isConnected ? (
            <button
              ...
              className="h-10 px-6 text-[16px] bg-button-primary text-white font-semibold rounded hover:opacity-90 transition-all duration-200 shadow-lg flex items-center justify-center"
            >
              Connect Wallet
            </button>
          ) : displayAddress ? (
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="h-10 px-4 text-[16px] backdrop-blur-sm border border-gray-600 text-white rounded hover:opacity-90 transition-all duration-200 shadow-lg flex items-center justify-center"
